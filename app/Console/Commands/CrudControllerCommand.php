...
EOD;
        ...
        return $this->replaceNamespace($stub, $name)->replaceValidationRequest($stub)
     ...
     * @return $this
     */
    protected function replaceValidationRequest(&$stub)
    {

        $stub = str_replace('{{validationRequestName}}', $this->getRequestName(), $stub);
        $stub = str_replace('{{validationRequestNamespace}}', $this->getRequestNameSpace(), $stub);
