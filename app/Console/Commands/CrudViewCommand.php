...
class CrudViewCommand extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($this->formFields as $key => $value) {
            ...
            $formBodyHtml = file_get_contents(resource_path('crud-generator/formBodyHtml.blade.php'));
            $formBodyHtml = $this->replaceformParts($formBodyHtml, $field);

            $formBodyHtmlForShowView = file_get_contents(resource_path('crud-generator/formBodyHtmlForShowView.blade.php'));
            $formHeadingHtml = file_get_contents(resource_path('crud-generator/formHeadingHtml.blade.php'));

            $this->formHeadingHtml .= $this->replaceformParts($formHeadingHtml, $field) . PHP_EOL;
            $this->formBodyHtml .= $formBodyHtml . PHP_EOL;
            $this->formBodyHtmlForShowView .= $this->replaceformParts($formBodyHtmlForShowView, $field) . PHP_EOL;
    ...
    private function replaceformParts($text, $field)
    {

        $replaces = ['%%field%%' => $field, '%%label%%' => strtolower($field), '%%crudNameSingular%%' => $this->crudNameSingular];
    ...
    {
        return [
            'index' => ['formHeadingHtml', 'crudNameSingular', 'formBodyHtml', 'crudName', 'crudNameCap', 'modelName', 'viewName', 'routeGroup', 'primaryKey'],
            'form' => ['formFieldsHtml','crudNameSingular'],
            'create' => ['crudName', 'crudNameCap', 'crudNameSingular', 'modelName', 'modelNameCap', 'viewName', 'routeGroup', 'viewTemplateDir'],
            'edit' => ['crudName', 'crudNameSingular', 'crudNameSingular', 'crudNameCap', 'modelNameCap', 'modelName', 'viewName', 'routeGroup', 'primaryKey', 'viewTemplateDir'],
