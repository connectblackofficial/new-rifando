    ...
    <div class="container bg-black" style="margin-top: 0px;">
        <div class="row">
            <div class="col-sm-8 bg-primary">
                ...
                <!-- Facebook -->
                <a class="btn btn-primary" style="background-color: #3b5998;width: 50px;" href="#!" role="button"><i
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('addProduct')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name"
                                               placeholder="Exemplo: Fusca 88" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="price"
                                               ...
                                               onkeyup="formatarMoeda()" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="numbers" min="1" max="99999"
                            ...
                            <button type="submit"
                                    onClick="this.form.submit(); this.disabled=true; this.value='Cadastrando…';"
                                    class="btn btn-success">Publicar
                            </button>
                        </form>
                    </div>
                </div>
