...
@section('content')
                ...
                <div class="container" style="background-color: #020f1e;">
                    <div class="row">
                        <div class="col-3" style="padding: 10px;">
                            <img src="{{imageAsset($image)}}" style="width: 100%;border-radius: 100%;">
                        </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist" style="font-size: 12px;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                   aria-controls="profile" aria-selected="false"><small style="text-align: center;">OPÇÃO
                                        2</small><br>CNPJ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                                   aria-controls="contact" aria-selected="false"><small style="text-align: center;">OPÇÃO
                                        2</small><br>QR CODE</a>
                            </li>
                        </ul>
    ...
    border-color: #ff2c2c;
">
                                            <smal>Copie o código abaixo e utilize a opção <b style="font-size: 18px;">"PIX
                                                    COPIA E COLA"</b> no aplicativo que você vai fazer o pagamento.
                                            </smal>
                                        </div>
                                    </div>
    ...
    justify-content: center;">
                                        <input type="text" readonly
                                               style="width: 100%;background-color: #f4f4f4;border: 3px solid #ffffff;border-style: dotted;border-radius: 5px;background-color: #132439;color: #fff;"
                                               id="brcodepix" value="<?= $codePIX; ?>"></input>
                                        <button type="button" id="clip_btn" class="btn blob"
                                                style="background-color: #ff9800!important;color: #fff;font-weight: bold;min-width: 130px;"
                                                data-toggle="tooltip" data-placement="top" title="COPIAR CÓDIGO PIX"
                                                onclick="copiar()">COPIAR CÓDIGO PIX</i></button>
                                    </div>
                                </div>

                                <small style="color: #fff;margin-top: 10px;text-align: center;justify-content: center;align-items: center;display: flex;">O
                                    tempo para você pagar acaba em: </small>
    ...
    font-size: 16px;">
                                ...
                                <div class="" style="text-align: center;">
                                    <a href="" style="color: #ff2c2c;font-weight: bold;" data-toggle="modal"
                                       data-target="#exampleModal">Como funciona?</a><br><br>
                                </div>
                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="card" style="border: none;text-align: center;">
                                    <div class="card-body" style="background-color: #020f1e;color: #fff;">
                                        ...
                                        <smal style="color: red;"><b>Atenção</b>: Pagamentos a com chave <b>CNPJ</b> é
    ...
    color: #fff;
    justify-content: center;
    display: flex;">Leia o QR CODE no aplicativo do seu banco para efetuar o pagamento!
                                </smal>
                ...
                <div class="card alert alert-success">
                    ...
                    <span style="font-size: 20px;color: #333;">Já fez o pagamento? Envie o comprovante de pagamento para nós!!! Envie pelo
                        <a href="https://api.whatsapp.com/send/?phone=55{{$telephoneConsulting->telephone}}&text=Olá,%20segue%20o%20meu%20comprovante%20de%20pagamento%20%20da(s)%20cota(s)%20{{$numbers}}"
                           target="_blank" style="font-size: 25px;color: #333;text-decoration: none;"> <span style="background-color: #28a745;
    padding: 5px;
    border-radius: 5px;
                ...
                <div class="modal-body" style="background-color: #18293c;">
                    <div class="row">
                        <div class="col-md-12" style="text-align: center;color: #fff;">
                            ...
                            <p>Cole o código, confirme o valor e faça o pagamento. O seu <b>número da sorte será
                                    confirmado na hora</b> :)</p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer" style="background-color: #18293c;">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"
                            style="width: 100%;background-color: #ff2c2c;border: none;">Ok, Entendi
                    </button>
                </div>
            </div>
        </div>
    ...
    opacity: 0.3;">1</span>
                        ...
                        <p class="" style="font-size: 20px;">Escolha o prêmio que gostaria de concorrer, verifique a
    ...
    opacity: 0.3;">3</span>
                        ...
                        <p class="" style="font-size: 20px;">Faça o pagamento no(s) método(s) de pagamento(s)
                            disponíveis no site.</p>
                    </div>
                    <div class="col-md-3" style="min-height: 200px;">
                    <span class="" style="font-size: 190px;
    position: absolute;
    ...
    opacity: 0.3;">4</span>
                        ...
                        <p class="" style="font-size: 20px;">Aguarde o Sorteio. Cruze os dedos! Você pode ser o próximo
                            sorteado.</p>
                    </div>
                </div>
            </div>
