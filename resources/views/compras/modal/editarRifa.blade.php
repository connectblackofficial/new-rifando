                                    ...
                                    <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="gateway" class="form-control">
                                                        <option value="mp" {{ $rifa->gateway == 'mp' ? 'selected' : '' }}>
                                                            Mercado Pago
                                                        </option>
                                                        <option value="paggue" {{ $rifa->gateway == 'paggue' ? 'selected' : '' }}>
                                                            Paggue
                                                        </option>
                                                        <option value="asaas" {{ $rifa->gateway == 'asaas' ? 'selected' : '' }}>
                                                            ASAAS
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control summernote" name="description"
                                                              id="desc-{{ $rifa->id }}" rows="10"
                                                              style="min-height: 200px;"
                                                              required>{!! $rifa->descricao() !!}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-pane fade"
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-5">
                                                    <div class="form-group">
                                                        <label for="status_sorteio">Status zzz
                                                            Sorteio</label>
