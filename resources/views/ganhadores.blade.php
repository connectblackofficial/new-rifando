            ...
            <div class="container">
                ...
                @foreach($winners as $winner)
                    ...
                    <div class="row mt-1" style="background-color: #fff;padding: 5px;border-radius: 20px;color: #000;">
                        <div class="col-2"
                             style="justify-content: center;align-items: center;text-align: center;display: flex;border: 1px green solid; border-radius: 15px;">
                        ...
                        <div class="col-8">
                            {!!$winner->winner!!}<br>
                            Sorteio: <a href="{{route('product', ['id' => $winner->id])}}"
                                        style="color:#28a745">{{$winner->name}}</a>
                        </div>
                        <div class="col-2"
                             style="justify-content: center;align-items: center;text-align: center;display: flex;">
                            <a href="{{route('product', ['id' => $winner->id])}}">
                                <img src="{{ $winner->getDefaultImageUrl()}}" class=""
                                     alt="{{$winner->name}}"
                                     style="min-height: 50px;max-height: 20px;border-radius:250px;">
                            </a>
                        </div>
                    </div>
