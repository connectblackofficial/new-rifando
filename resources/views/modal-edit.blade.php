                        ...
                        <div class="col">
                            <nav>
                                <ul class="nav nav-tabs" id="myTab" role="tablist" style="font-size: 12px;">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="geral-tab" data-toggle="tab" href="#geral"
                                           role="tab" aria-controls="geral" aria-selected="true">Geral</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="ajustes-tab" data-toggle="tab" href="#ajustes"
                                           role="tab" aria-controls="ajustes" aria-selected="false">Ajustes</a>
                                    </li>
                                </ul>
                            </nav>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="{{imageAsset($product->image)}}" class="mt-1" alt="..."
                                ...
                                <div class="tab-pane fade" id="ajustes" role="tabpanel" aria-labelledby="ajustes-tab">
                                    <div class="row mt-3">
                                        <div class="col-5">
                                            <div class="form-group">
                                                <?php
                                                echo selectField('status_sorteio', \App\Enums\ActiveInactiveAsStringEnum::getValues(), ['status_sorteio' => $product->status]);
                                                ?>
                                            </div>
                                        </div>
                                        <div class="col-7">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="data_sorteio"
                                                       value="{{ \Carbon\Carbon::parse($product->draw_date)->format('Y-m-d')}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-sm">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="cadastrar_ganhador"
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="mostrar_pagina_icicial">
                                                    ...
                                                    <option value="1" {{$product->visible == 1 ? "selected='selected'" : ''}}>
                                                        Sim
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="favoritar_rifa">
                                                    <option value="0">Não</option>
                                                    <option value="1" {{$product->favoritar == 1 ? "selected='selected'" : ''}}>
                                                        Sim
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="previsao_sorteio"
                                                       value="{{ \Carbon\Carbon::parse($product->draw_prediction)->format('Y-m-d')}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-3">
