...
@section('ogUrl', url(''))
@section('ogImage', imageAsset( $rifa->image))
@section('sidebar')

    @section('ogContent')
        <meta property="og:title" content="{{ 'Resumo' . $rifa->name }}">
        <meta property="og:description" content="{{ $rifa->subname }}">
        <meta property="og:image" itemprop="image" content="{{imageAsset( $rifa->image)}}">
                    ...
                    <div>
                        ...
                        @foreach ($rifa->participantes() as $participante)
                            <div class="row body-resumo pt-2">
                                ...
                                <div class="col-md-2 d-flex align-items-center">
                                    <a href="{{ route('resumoRifaPDF', $participante->id) }}" target="_blank"
                                       class="btn btn-sm btn-info"><i class="fas fa-file-pdf"></i>&nbsp;PDF</a>
                                </div>
                            </div>
                        @endforeach
                </div>
