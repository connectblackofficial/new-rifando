...
<input type="number" style="text-align: center;background-color: #E5E5E5;color: #000000;font-weight: bold; display:none"
    ...
    <div class="d-flex justify-content-between font-weight-600 mb-2">
        ...
        <div class="seletor-item rounded d-flex justify-content-between box-shadow-08 font-xs product-number-reserved" style="cursor: pointer;"
        ...
        <div class="seletor-item rounded d-flex justify-content-between box-shadow-08 font-xs product-number-paid" style="cursor: pointer;"
...
<div class="container text-center">
    <div class="raffles {{ $product->status == 'Finalizado' ? 'finished' : '' }} qty-numbers-zeros-{{$product->qtd_zeros}}" id="raffles"
