...
@endif
{{-- Promoções --}}
@if (count($productResume['active_promos'])>0)
    <div class="" style="">
    ...
    <div class="card" style="border: none;border-radius: 10px;background-color: transparent; margin-top: -15px;">
        <div class="card-body body-promo {{ $config->tema }}">
            <div class="row">
                    ...
                    ?>
                @foreach ($productResume['active_promos'] as $promo)
                    @if ($productFromCache['type_raffles'] == \App\Enums\RaffleTypeEnum::Manual)
