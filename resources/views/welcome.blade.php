...
@section('content')
    <style>
        ...
        <img src="https://eemkt.svicente.com.br/wp-content/themes/svicente/img/renovasuacasa/banner2-desktop.webp" class="rounded-md" style="filter: hue-rotate(15deg);">
        ...
        <div class="row" style="margin-top: 25px; margin-bottom: 25px;">
            ...
            <div class="col-md-3">
                <div class="d-flex" style="column-gap: 15px; background: #ffffff9c; border-radius: 10px; padding: 10px;">
                    <div class="step" style="width: 70px;height: 70px;background: #0000000d;border-radius: 50px;font-size: 25px;text-align: center;padding: 10px;"><img src="https://coisasderh.com.br/wp-content/uploads/2023/02/Certificate-NOV-830x1024.webp" style="position: relative; top: -8px;"></div>
                    <div style="display: grid; align-content: center;">
